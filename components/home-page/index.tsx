...
const initMenuList: menuType[] = [
  {
    ...
    region: 'cn',
    language: 'SC',
    imgUrl: `${process.env.NEXT_PUBLIC_IMG_URL}assets/img_sc.webp`,
  ...
  },
  {
    ...
    region: 'hk|mo',
    language: 'HK',
    imgUrl: `${process.env.NEXT_PUBLIC_IMG_URL}assets/img_hk.webp`,
  ...
  },
  {
    ...
    region: 'tw',
    language: 'TW',
    imgUrl: `${process.env.NEXT_PUBLIC_IMG_URL}assets/img_tw.jpg`,
    tips: '請在移動設備的縱向顯示模式下瀏覽此頁',
  },
  {
    id: 3,
    region: 'jp',
    language: 'JP',
    imgUrl: `${process.env.NEXT_PUBLIC_IMG_URL}assets/img_jp.webp`,
  ...
  },
  {
    ...
    region: 'kr',
    language: 'KR',
    imgUrl: `${process.env.NEXT_PUBLIC_IMG_URL}assets/img_kr.webp`,
